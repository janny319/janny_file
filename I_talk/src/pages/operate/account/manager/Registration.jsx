...
import plusBtn from '@/assets/icon/ico_plus.svg';
import minusBtn from '@/assets/icon/ico_minus.svg';
        ...
        <>
            <div className="pop-content">
                ...
                <div className="input-box">
                    ...
                    />
                    <button type="button" onClick={duplicateClick} className="btn line black small">
                        중복검사
                    </button>
                </div>
