        ...
        <div className="content">
            ...
            <div className="acount-setting border-box">
                ...
                <div className="info-textbox">
                    ...
                    <div className="radio-box">
                        <div className="radio-btn">
                            ...
                            <label htmlFor="radio01">필수</label>
                        </div>
                        <div className="radio-btn">
                            <input id="radio02" type="radio" name="authority" />
                            <label htmlFor="radio02">선택</label>
                        </div>
                    </div>
                </div>
                <div className="info-textbox">
                    ...
                    <div className="radio-box">
                        <div className="radio-btn">
                            ...
                            <label htmlFor="radio03">아이디와 동일</label>
                        </div>
                        <div className="radio-btn">
                            <input id="radio04" type="radio" name="authority" />
                            <label htmlFor="radio04">직접입력</label>
                        </div>
                    </div>
                    <input
                        type="text"
                ...
                <div className="btn-list right">
                    <button className="btn line black big">수정사항 초기화</button>
